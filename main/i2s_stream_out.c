...
//    SET_PERI_REG_BITS(I2S_RXEOF_NUM_REG(0), I2S_RX_EOF_NUM, (BUFF_SIZE_BYTES - 8) / 2, I2S_RX_EOF_NUM_S);
    SET_PERI_REG_BITS(I2S_OUT_LINK_REG(0), I2S_OUTLINK_ADDR, ((uint32_t) &s_dma_desc), I2S_OUTLINK_ADDR_S);
    SET_PERI_REG_BITS(I2S_OUT_LINK_REG(0), 0x1, 1, I2S_OUTLINK_START_S);
